...
public class AddMemberActivity extends AppCompatActivity
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int genderNameColumnIndex = cursor.getColumnIndex(MemberEntry.COLUMN_GENDER);
            int sportNameColumnIndex = cursor.getColumnIndex(MemberEntry.COLUMN_SPORT);

            String firstName = cursor.getString(firstNameColumnIndex);
            String lastName = cursor.getString(lastNameColumnIndex);
            int gender = cursor.getInt(genderNameColumnIndex);
            String sport = cursor.getString(sportNameColumnIndex);
    ...
    private void deleteMember() {
        if (currentMemberUri != null) {
            ...
            if (rowsDeleted == 0) {
                Toast.makeText(this, "Deleting data from the table failed",
                        Toast.LENGTH_LONG).show();
            } else {
